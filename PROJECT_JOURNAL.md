...
- **Alpha 5** — опубликованный portable prerelease на B40. **Alpha 6** —
  ...
  тайминги и контроллеры в нём не менялись. Alpha 6 остаётся стабильной точкой
  для отката.
...
5. Rage на отдельных старых пользовательских носителях следует исследовать по
   разметке/FAT/содержимому конкретного образа; чистые 500-МБ и синтетические
   4-ГБ носители уже проходят Rage и не дают основания считать размер носителя
   общей ошибкой.
