...
- Чистый пакет для пользовательской runtime-приёмки, не изменяющий Alpha 7:
  ...
  **не релиз и не GitHub-публикация**.
...
3. **CD/ATAPI для BaseConf**: B41 local test build готов к пользовательской
   runtime-приёмке с реальным BaseConf-софтом. ATM Turbo в эту задачу не
