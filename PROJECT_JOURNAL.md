...
3. **CD/ATAPI для BaseConf**: возможный read-only CD/DVD-привод Windows как IDE
   Slave. ATM Turbo в эту задачу не включается: его эмуляция пока не менялась и
   будет отдельным будущим циклом.
