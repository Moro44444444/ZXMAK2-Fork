...
- Пользователь пожелал добавить `F12` как удобную дополнительную клавишу Warm Reset. Существующую `Alt+Ctrl+Insert` сохраняем для обратной совместимости; менять её не требуется.
